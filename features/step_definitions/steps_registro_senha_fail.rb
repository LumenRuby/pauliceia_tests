...
Then('I should fill the {string}, {string}, {string} but not {string} fields with the corresponding values') do |name_field, password_field, username_field, email_field|
  ...
  # Replace 'your_name', 'your_password', 'your_username' with actual values
