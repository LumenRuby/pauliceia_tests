...
Then('I should fill the {string}, {string}, {string} but not {string} fields with the corresponding values') do |email_field, password_field, username_field, name_field|
  ...
  # Replace 'your_email', 'your_password', 'your_username' with actual values
